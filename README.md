...
See [Releases](https://github.com/GluuFederation/docker-scim/releases) for stable versions.
For bleeding-edge/unstable version, use `gluufederation/scim:4.3.0_dev`.
